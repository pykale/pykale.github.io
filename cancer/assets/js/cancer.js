document.getElementById('copyrightYear').textContent = new Date().getFullYear();
  ...
  function renderTree(){
    ...
    const intro = `<div class="story-intro"><img class="hero-cell" src="assets/images/cancer-cell.png" alt="" aria-hidden="true"><p class="story-kicker">Multimodal survival modelling · research narrative</p><h2>From patient data to reliable risk-over-time research.</h2><p>See how a clinical question, the HANCOCK case study and a reusable KaleCancer workflow connect to evaluation and the next study.</p><div class="story-contact"><span>Have thoughts on KaleCancer, or a clinical question or cohort to explore with us?</span><a href="https://forms.gle/Z1WkKLNoZXpWQDSr6" target="_blank" rel="noopener">Feedback and Collaboration →</a></div><div class="story-stats"><span class="story-stat"><strong>763</strong><span>HANCOCK patients</span></span><span class="story-stat"><strong>3</strong><span>proposed extensions</span></span><span class="story-stat"><strong>3</strong><span>fusion stages</span></span><span class="story-stat"><strong>${STORY_CAPABILITIES.length}</strong><span>key points</span></span></div></div>`;
  ...
  function openPanel(id, triggerEl){
    ...
    els.panel.innerHTML = `
      ...
      ${c.journey==='ask' ? `<div class="panel-section"><h4>Feedback and Collaboration</h4><p>Have feedback on KaleCancer, or interested in collaborating on a study? <a href="https://forms.gle/Z1WkKLNoZXpWQDSr6" target="_blank" rel="noopener">Share it through our Feedback and Collaboration form</a> and we will follow up with you.</p></div>` : ''}
